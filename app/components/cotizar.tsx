...
export default function Restauracion() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const numeroWhatsApp: string = "1234567890";
  ...
  return (
    <div className="bg-gris min-h-screen py-12 px-6 relative">
      ...
      <p className="text-crema/50 text-lg text-center mb-12">
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          <div>
            <label
              htmlFor="nombre"
              className="block text-marron font-semibold mb-2"
            >
              Nombre
            </label>
            <input
      ...
      <div className="absolute bottom-0 right-0 w-[80%] h-[12vh] lg:h-[35vh] overflow-hidden max-w-full z-0">
        <div className="relative w-full h-full transform translate-x-[35%]">
          <Image
            src="/iconcotizar.png"
