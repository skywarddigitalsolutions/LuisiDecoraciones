            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-36 mt-16 lg:mt-20 lg:px-12 lg:justify-center">
                <div className="flex lg:flex-col items-center">
                    <div className="text-marron p-4 lg:p-2 rounded-full flex items-center justify-center">
                        <CheckBadgeIcon className="w-8 h-8 lg:w-16 lg:h-16" />
                    </div>
                    <div className='flex lg:flex-col gap-1'>
                        <p className="text-marron text-xl lg:text-4xl text-center font-semibold">+80 AÑOS</p>
                        <p className="text-marron text-xl lg:text-lg text-center font-semibold">EN EL RUBRO</p>
                    </div>
                </div>
                <div className="flex lg:flex-col items-center">
                    <div className="text-marron p-4 lg:p-2 rounded-full flex items-center justify-center">
                        <StarIcon className="w-8 h-8 lg:w-16 lg:h-16" />
                    </div>
                    <div className='flex lg:flex-col gap-1'>
                    <p className="text-marron text-xl lg:text-4xl text-center font-semibold">SERVICIO</p>
                    <p className="text-marron text-xl lg:text-lg text-center font-semibold">PERSONALIZADO</p>
                    </div>
                </div>
                <div className="flex lg:flex-col items-center ">
                    <div className="text-marron p-4 lg:p-2 rounded-full flex items-center justify-center">
                        <HiWrenchScrewdriver className="w-8 h-8 lg:w-16 lg:h-16" />
                    </div>
                    <div className='flex lg:flex-col gap-1'>
                    <p className="text-marron text-xl lg:text-4xl text-center font-semibold">CORTES</p>
