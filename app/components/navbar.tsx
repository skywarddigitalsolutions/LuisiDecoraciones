...
const products = [
  {
    ...
    description: "Trabajamos una amplia variedad de cortes",
    href: "/servicios/cortes-a-medida",
    icon: ChartPieIcon,
  },
  {
    name: "Muebles a medida",
    description: "Lo creamos especialmente para vos",
    href: "/servicios/muebles-a-medida",
    icon: CursorArrowRaysIcon,
  },
  {
    name: "Restauración",
    description: "Cotizá tu restauración",
        ...
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <div className="flex justify-center items-center gap-2">
              ...
              <h5 className="text-beige font-bold text-md ">
                Luisi Decoraciones
              </h5>
            </div>
          </a>
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-beige">
              ...
              <ChevronDownIcon
                aria-hidden="true"
                className="h-5 w-5 flex-none text-beige"
              />
            </PopoverButton>
                ...
                {products.map((item) => (
                  ...
                  >
                    <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-beige group-hover:bg-marron">
                      <item.icon
                        aria-hidden="true"
                        className="h-6 w-6 text-marron group-hover:text-beige"
                      />
                    </div>
                    <div className="flex-auto">
                      <a
                        href={item.href}
                        className="block font-semibold text-crema hover:text-marron"
                      >
                        {item.name}
                        <span className="absolute inset-0" />
                      </a>
                      <p className="mt-1 text-white group-hover:text-marron">
                        {item.description}
                      </p>
                    </div>
                  </div>
          ...
          <a
            href="/productos"
            className="text-sm font-semibold leading-6 text-beige"
          >
            Productos
          </a>
          <a
