...
export default function ServiciosHero() {
    ...
    <>
        <Head>
                <title>Servicios | Luisi Decoraciones</title>
                <meta name="description" content="Descubre los servicios de Luisi Decoraciones: cortes de madera a medida, muebles personalizados y restauración de muebles. Calidad y atención personalizada desde 1936." />
                <meta name="keywords" content="Luisi Decoraciones, cortes a medida, muebles personalizados, restauración de muebles, carpintería, Monte Castro, madera, MDF, pino, OSB" />
        ...
        <section className="bg-gris min-h-screen flex flex-col items-center py-12 relative">
            <h2 className="text-crema text-4xl md:text-5xl font-bold text-center pt-20 pb-12">Servicios</h2>
